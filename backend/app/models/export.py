...
This module defines ORM models related to export operations within the database.
It enables tracking and management of data exports performed by users, including
export types, timestamps, associated user or session information, and metadata
about the exported data.

Key Responsibilities:
- Define a data model representing export history records for audit, analytics,
  and user support.
...
- Facilitate querying export history to provide users with a record of their
  previous exports.
...
- Reference ExportHistory for displaying export logs in user interfaces or
  admin dashboards.
